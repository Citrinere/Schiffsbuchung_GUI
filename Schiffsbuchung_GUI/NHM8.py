...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Bilder/SchiffIcon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        MainWindow.setWindowIcon(icon)
        MainWindow.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        MainWindow.setAutoFillBackground(False)
        MainWindow.setStyleSheet("QMainWindow{background-image: url(:/newPrefix/Cruise Background 3.jpg) 0 0 0 0 stretch stretch;}")
...
"color: white;")
        ...
        self.toolButtonStadt.setGeometry(QtCore.QRect(310, 20, 200, 41))
