...
class PersonalDataDialog(QWidget):
    ...
    def saveData(self):
        ...
        # print(textboxValue)
        # print("Test numero dos: ", self.OrderWindow.bestellData)
        # print("Test numero tres: ", self.confirmOrder.bestellData)
        # textboxValue.append(self.OrderWindow.bestellData)                     # lässt das programm am ende abstürzen
