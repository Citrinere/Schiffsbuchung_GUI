...
class CheckableComboBox(QtWidgets.QComboBox):   # Event Handler
    def __init__(self):
...
class Dialog_01(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.toolbutton = QtWidgets.QToolButton(self) #1
            # => self.toolButtonStadt = QtWidgets.QToolButton(self.centralwidget)
        ...
        for i in range(4):  # Menge der Items in der Kategorie
